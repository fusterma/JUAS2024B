...
For the workshop we will ask you to download the last version of [this repository](https://github.com/fusterma/JUAS2023/zipball/master). In this repository you will find one folder for each tutorial with the corresponding jupyter-notebook and .madx file to be completed during the workshop as well as the solutions.  
